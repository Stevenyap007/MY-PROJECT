...
for i, image_path in enumerate(train_images):
    ...
    # cv2.imshow('trainimage',image)
    # cv2.waitKey(0)
    detected_faces = classifier.detectMultiScale(image, scaleFactor=1.1, minNeighbors=5)
...
for i, image_path in enumerate(test_images):
    ...
    # cv2.waitKey(0)
    detected_faces = classifier.detectMultiScale(image_gray, scaleFactor=1.1, minNeighbors=5)
