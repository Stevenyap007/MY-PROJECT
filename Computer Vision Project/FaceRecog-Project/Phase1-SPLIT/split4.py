...
train_images = [cv2.imread(path,cv2.IMREAD_GRAYSCALE) for path in train_image_paths]
test_images = [cv2.imread(path,cv2.IMREAD_GRAYSCALE) for path in test_image_paths]
